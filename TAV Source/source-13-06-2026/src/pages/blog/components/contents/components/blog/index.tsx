      ...
      >
        {currentBlogs.map((item, index) => (
          <GridItem
            ...
            _hover={{ transform: "translateY(-10px)", boxShadow: "0px 15px 30px rgba(0, 0, 0, 0.1)" }}
          >
            <Box
              m={"30px"}
              position={"absolute"}
          ...
          {getPaginationRange(currentPage, totalPages).map((page, i) => {
            ...
            return (
              <Box
                ...
                _hover={{ bg: "#F5712A", color: "white", transform: "translateY(-3px)", boxShadow: "0px 5px 15px rgba(245, 113, 42, 0.4)" }}
                transition="all 0.3s ease"
              >
                {page}
              </Box>
