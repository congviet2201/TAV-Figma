  ...
  return (
    ...
    >
      <Stack
        ...
        _hover={{ transform: "translateY(-3px)", boxShadow: "0px 10px 20px rgba(245, 113, 42, 0.4)", opacity: 0.9 }}
      >
        {isLoading ? (
          <Text
            fontWeight={"400"}
      ...
      <Stack
        ...
        className="transition-fast"
        _hover={{ transform: "translateY(-3px)", boxShadow: "0px 10px 20px rgba(0, 0, 0, 0.1)", bg: isDarkMode ? "#f0f0f0" : "#2a2a2a" }}
      >
